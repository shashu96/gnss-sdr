/*!
 * \file gps_l1_ca_dll_kf_tracking_test.cc
 * \brief  This class implements a tracking test for GPS_L1_CA_DLL_KF_Tracking
...
#include "gps_l1_ca_dll_kf_tracking.h"
...
class GpsL1CADllKfTrackingTest_msg_rx;

typedef boost::shared_ptr<GpsL1CADllKfTrackingTest_msg_rx> GpsL1CADllKfTrackingTest_msg_rx_sptr;
...
private:
    ...
    GpsL1CADllKfTrackingTest_msg_rx();
...
void GpsL1CADllKfTrackingTest_msg_rx::msg_handler_events(pmt::pmt_t msg)
{
    try
    {
...
GpsL1CADllKfTrackingTest_msg_rx::GpsL1CADllKfTrackingTest_msg_rx() :
            gr::block("GpsL1CADllKfTrackingTest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
    this->message_port_register_in(pmt::mp("events"));
    this->set_msg_handler(pmt::mp("events"), boost::bind(&GpsL1CADllKfTrackingTest_msg_rx::msg_handler_events, this, _1));
    rx_message = 0;
}
...
class GpsL1CADllKfTrackingTest: public ::testing::Test
{
...
int GpsL1CADllKfTrackingTest::configure_generator()
{
...
int GpsL1CADllKfTrackingTest::generate_signal()
{
    int child_status;
...
void GpsL1CADllKfTrackingTest::configure_receiver()
{
...
void GpsL1CADllKfTrackingTest::check_results_acc_carrier_phase(arma::vec true_time_s,
        arma::vec true_value,
        arma::vec meas_time_s,
        arma::vec meas_value)
{
...
void GpsL1CADllKfTrackingTest::check_results_codephase(arma::vec true_time_s,
        arma::vec true_value,
        arma::vec meas_time_s,
        arma::vec meas_value)
{
