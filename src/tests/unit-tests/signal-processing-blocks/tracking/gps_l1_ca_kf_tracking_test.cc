...
GpsL1CAKfTrackingTest_msg_rx::GpsL1CAKfTrackingTest_msg_rx() :
            gr::block("GpsL1CAKfTrackingTest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
...
TEST_F(GpsL1CAKfTrackingTest, ValidationOfResults)
{
    ...
    std::shared_ptr<TrackingInterface> tracking = std::make_shared<GpsL1CaKfTracking>(config.get(), "Tracking_1C", 1, 1);
