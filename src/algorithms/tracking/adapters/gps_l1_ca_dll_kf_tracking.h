...
#ifndef GNSS_SDR_GPS_L1_CA_DLL_KF_TRACKING_H_
#define GNSS_SDR_GPS_L1_CA_DLL_KF_TRACKING_H_
...
{
public:
    GpsL1CaDllKfTracking(ConfigurationInterface* configuration,
            std::string role,
            unsigned int in_streams,
            unsigned int out_streams);

    virtual ~GpsL1CaDllKfTracking();
    ...
    //! Returns "GPS_L1_CA_DLL_KF_Tracking"
    std::string implementation()
    {
        return "GPS_L1_CA_DLL_KF_Tracking";
    }
...
#endif // GNSS_SDR_GPS_L1_CA_DLL_KF_TRACKING_H_
