/*!
 * \file gps_l1_ca_dll_kf_tracking_cc.cc
...
#include "gps_l1_ca_dll_kf_tracking_cc.h"
#include <cmath>
#include <iostream>
#include <memory>
#include <sstream>
...
gps_l1_ca_dll_kf_make_tracking_cc(
        long if_freq,
        long fs_in,
...
void Gps_L1_Ca_Dll_Kf_Tracking_cc::forecast (int noutput_items,
...
void Gps_L1_Ca_Dll_Kf_Tracking_cc::start_tracking()
{
    /*
...
int Gps_L1_Ca_Dll_Kf_Tracking_cc::general_work (int noutput_items __attribute__((unused)), gr_vector_int &ninput_items __attribute__((unused)),
...
void Gps_L1_Ca_Dll_Kf_Tracking_cc::set_channel(unsigned int channel)
{
    d_channel = channel;
...
void Gps_L1_Ca_Dll_Kf_Tracking_cc::set_gnss_synchro(Gnss_Synchro* p_gnss_synchro)
{
